...
class MetricItem(models.Model):
    ...
    metric = models.ForeignKey(Metric, verbose_name=_('metric'), on_delete=django.db.models.deletion.CASCADE)
...
class MetricMonth(models.Model):
    ...
    metric = models.ForeignKey(Metric, verbose_name=('metric'), on_delete=django.db.models.deletion.CASCADE)
    num = models.BigIntegerField(_('number'), default=0)
    created = models.DateField(_('created'), default=datetime.date.today)
